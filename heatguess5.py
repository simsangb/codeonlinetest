...
df1= round(pd.read_excel("heatguess5.xlsm", 'Data Normalize', skiprows=17 ,na_values=['NA','?'] ),3)
df2= round(pd.read_excel("heatguess5.xlsm", 'data2', skiprows=17 ),3)
df3= round(pd.read_excel("heatguess5.xlsm", 'data3', skiprows=17 ),3)
df4= round(pd.read_excel("heatguess5.xlsm", 'data4', skiprows=17 ),3)
df5= round(pd.read_excel("heatguess5.xlsm", 'data5', skiprows=17 ),3)
df6= round(pd.read_excel("heatguess5.xlsm", 'data6', skiprows=17 ),3)
df7= round(pd.read_excel("heatguess5.xlsm", 'data7', skiprows=17 ),3)
...
train_X, train_y = X[:1700, :], y[:1700]
print(train_X)
val_X, val_y = X[1000:1700, :], y[1000:1700]
test_X, test_y = X[1000:1700, :], y[1000:1700]
...
torch.save(model.state_dict(),'winterholiday.pt')
...
ttlist2 = [-10,-10,-11,-11,-11,-11,-11,-11,-11,-10,-9,-7,-6,-5,-3,-2,-2,-2,-3,-3,-3,-4,-4,-5]
