...
layout = [[sg.Text('선택 →'),sg.Radio('평일','dday', key ='-normalday-',default=True),sg.Radio('휴일','dday', key='-holiday-')],
          ...
          [sg.Text('예상 온도(입력)',size=(16,1),font='gothic',text_color='white'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in0-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in1-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in2-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in3-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in4-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in5-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in6-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in7-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in8-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in9-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in10-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in11-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in12-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in13-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in14-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in15-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in16-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in17-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in18-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in19-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in20-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in21-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in22-'),sg.InputText(size=(3,1),font='gothic',background_color='white',text_color='black',key='-in23-')],
