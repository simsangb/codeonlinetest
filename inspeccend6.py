...
# --입입관경보다 PDCV관경이 두단계 이상 아래일 경우, PDCV관경을 입인의 두단계아래로 배관경 상승--------------------------------------------------------------------------------------------------
...
def selected8(event):
    ...
    if checked6.get() == "STS" :
        pd6=[14459,8097,3963,2473,1476,718.5,463.9,166.6,108.4,59.9,35.2,17.6,6.9]
    if checked6.get() == "동관" :
        pd6=[12844,7185,3490,2150,1213,582.2,368.1,198.4,97.6,61.8,33.7,17.1,6.5]               
